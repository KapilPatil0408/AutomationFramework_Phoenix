...
public class LoginAPIJSONDataDrivenTest {
	...
	@Test(description = "Verify if login api working for FD user", groups = { "api", "regression",
			"datadrivern" }, dataProviderClass = com.dataproviders.DataProviderUtils.class, dataProvider = "loginAPIJsonDataProvider")
