...
public class DatabaseManager {
	...
	private volatile static HikariDataSource hikariDataSource; // Any update that happens to this conn variable! all
																// thread
	...
	private static void initialzePool() {
	...
	public static Connection getConnection() throws SQLException {
		...
		if (hikariDataSource == null) {
			initialzePool(); // Automatic Initialzation of HikariDataSource
